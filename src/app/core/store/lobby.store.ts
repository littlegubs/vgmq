...
export class LobbyStore {
  ...
  private lobbyResultDataBehaviorSubject = new BehaviorSubject<{ patreons: string[]; databaseContributors: string[] }>(
    null
  )
  ...
  public readonly lobbyResultData: Observable<{ patreons: string[]; databaseContributors: string[] }> =
    this.lobbyResultDataBehaviorSubject.asObservable()
  ...
  setResultData(data: { patreons: string[]; databaseContributors: string[] }): void {
    this.lobbyResultDataBehaviorSubject.next(data)
  }
}
